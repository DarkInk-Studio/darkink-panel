...
const ScreenBlock = ({ title, image, message, onBack, onRetry }: ScreenBlockProps) => (
    <PageContentBlock>
        <div css={tw`flex justify-center`}>
            <div
                css={tw`w-full sm:w-3/4 md:w-1/2 p-8 md:p-12 bg-neutral-800 border border-neutral-600 rounded-xl shadow-none text-center relative`}
            >
                ...
                <img src={image} css={tw`w-1/2 max-w-xs h-auto select-none mx-auto opacity-80`} />
                <h2 css={tw`mt-8 text-neutral-100 font-bold text-3xl`}>{title}</h2>
