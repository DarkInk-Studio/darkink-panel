    ...
    return (
        <div
            className={classNames(
                'flex items-start border text-gray-50 rounded-xl px-4 py-3',
                {
                    ['border-red-500/40 bg-red-500/10']: type === 'danger',
                    ['border-yellow-500/40 bg-yellow-500/10']: type === 'warning',
                },
                className
            )}
        >
